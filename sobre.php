		...
		<div class="container">
			...
			<div class="about-text">
				...
				<div class="col-md-6 about-text-right">
					...
					<p> O InfColeta é um projeto desenvolvido pelos alunos Ariana Picolotto, Caroline Rosa, Gabrieli Mallet, Gabriella Selbach e Igor Phelype Guimarães no Instituto Federal de Educação, Ciência e Tecnologia Sul-Rio-Grandense - Campus Charqueadas durante o 1ª Edição da CharCode. Tem como objetivo:
